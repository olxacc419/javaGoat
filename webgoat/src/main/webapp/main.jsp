	 	 		...
	 	 		if (webSession.getHint() != null)
	 	 			...
	 	 			if (webSession.getParams() != null)
	 	 			{
	 	 				...
	 	 				while (i.hasNext())
	 	 				{
	 	 					...
	 	 					printParameters = "<div id=\"parameter\" class=\"info\">" + p.getGroupName() + "=" + p.getValue() + "</div><br>";
		...
		<div id="bottom">
			<div align="center"><a href="http://www.owasp.org">OWASP Foundation</a> | 
								...
								<a href="mailto: <%=webSession.getWebgoatContext().getFeedbackAddress()%>?subject=WebGoat Bug Report - Lesson: 
												 <%=webSession.getCurrentLesson().getGroupName()%>">Report Bug</a>
			</div>
	  	</div>
	</div>
</body>
